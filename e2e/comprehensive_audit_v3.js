...
async function runAudit() {
    ...
    try {
        ...
        try {
            let addBtn = await driver.$('~Add Account'); // Icon
            if (!await addBtn.isDisplayed()) addBtn = await driver.$('//*[contains(@text, "Add")]'); // Text
            await addBtn.click();
