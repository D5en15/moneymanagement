...
async function runAudit() {
    ...
    try {
        ...
        try {
            ...
            // If failed, try to close dialog to continue or just let it fail
            await driver.back(); 
        }

        // --- TEST 4: SETTINGS (VIA HOME) ---
        log("Navigation", "INFO", "Switching to Home first...");
        if (await driver.isKeyboardShown()) await driver.hideKeyboard();
